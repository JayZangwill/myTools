...
gulp.task('dev:image:watch', ['dev:image'], function() {
	return gulp.watch(['src/images/**/*.{jpg,jpge,png,gif,ico}', '!src/images/sprite/**/*.{jpg,jpge,png,gif,ico}'], ['dev:image']);
});
...
gulp.task('dev', ['dev:html:watch', 'dev:css:watch', 'dev:js:watch', 'dev:image:watch','dev:static:watch', 'dev:browser']);
